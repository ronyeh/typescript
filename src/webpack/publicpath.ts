...
// This file is full of Webpack black magic.
...
// - specify the base path at runtime via a global `CHUNK_BASE_PATH` variable. For example, window.CHUNK_BASE_PATH = '/my/path/'.
//
// If `CHUNK_BASE_PATH` is not specified via either of the above methods, this script will attempt to determine the base path
...
function globalObject(): typeof globalThis & any {
...
if (g.CHUNK_BASE_PATH) {
    addPublicPath(g.CHUNK_BASE_PATH);
}
